...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        header("Location: /activity.php?id=$newId");
        exit;
    }
}
    ...
    <div class="token-estimate-box" id="tokenEstimate"
      ...
      <div style="text-align:right;flex-shrink:0;">
        ...
        <?php if ($user['tokens_balance'] < 150): ?>
          <a href="/tokens.php" style="font-size:11px;color:var(--primary);">+ Comprar tokens</a>
        <?php endif; ?>
      </div>
    </div>
      ...
      <div style="display:flex;align-items:center;gap:10px;">
        ...
        <div>
          ...
          <div style="font-size:13px;color:var(--text2);">
            Puedes publicar incidencias y eventos gratis. Para actividades lucrativas necesitas <a href="/subscriptions.php">Pro o Platinum</a>.
          </div>
        </div>
      </div>
    </div>
