...
<div class="page-content">
  ...
  <div class="page-header">
    ...
    <a href="<?= url_for('dashboard.php') ?>" class="btn btn-outline btn-sm">
  ...
  <?php if (empty($upcoming) && empty($past)): ?>
    ...
    <div class="events-empty">
      ...
      <a href="<?= url_for('dashboard.php') ?>" class="btn btn-primary">Explorar el mapa</a>
    </div>
      ...
      <div class="event-card" data-id="<?= $ev['id'] ?>">
        ...
        <div class="event-card-body">
          ...
          <div class="event-card-info">
            <a href="<?= url_for('activity.php') ?>?id=<?= $ev['id'] ?>" class="event-card-title">
