...
?>
    ...
    <div class="dashboard-shell">
        ...
        <div class="map-pub-list">
          ...
          <?php else: ?>
            <?php foreach ($publications as $pub): ?>
              ...
              ?>
              <div class="map-pub-item" data-id="<?= $pub['id'] ?>"
      ...
      <div class="map-container">
        ...
        <!-- Detail panel (slides in from right over map) -->
    ...
    <script>
    // Wire up filter chips to map
    document.querySelectorAll('.filter-chip[data-filter]').forEach(chip => {
      chip.addEventListener('click', function () {
        document.querySelectorAll('.filter-chip[data-filter]').forEach(c => c.classList.remove('active'));
        this.classList.add('active');
        if (window.CityLiveMap) {
          window.CityLiveMap.loadPublications(this.dataset.filter === 'all' ? null : this.dataset.filter);
        }
      });
    });
    </script>
