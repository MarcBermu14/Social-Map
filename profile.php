...
<div class="profile-layout">
  ...
  <div class="profile-info-row">
    ...
    <div style="display:flex;flex-direction:column;gap:8px;flex-shrink:0;align-items:flex-end;">
      <?php if ($isMe): ?>
        ...
        <a href="/subscriptions.php" class="btn btn-outline btn-sm">
          <i class="fa-solid fa-crown"></i> Gestionar plan
        </a>
        <a href="/create.php" class="btn btn-outline btn-sm">
  ...
  <?php if (empty($regEvents)): ?>
    <div class="card mb-24" style="text-align:center;padding:32px;color:var(--text3);">
      ...
      <a href="/dashboard.php" style="font-size:13px;color:var(--primary);margin-top:8px;display:inline-block;">Explorar eventos →</a>
    </div>
  <?php else: ?>
    <div class="reg-events-grid mb-24">
      <?php foreach ($regEvents as $ev): ?>
        ...
        ?>
        <a href="/activity.php?id=<?= $ev['id'] ?>" class="reg-event-card">
  ...
  <?php else: ?>
    <div class="pub-grid">
      <?php foreach ($pubs as $p): ?>
        ...
        ?>
        <a href="/activity.php?id=<?= $p['id'] ?>" class="pub-item" style="flex-direction:column;align-items:flex-start;gap:10px;">
